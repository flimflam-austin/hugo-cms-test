...
"use strict";var _require=require("@sanity/block-content-to-hyperscript/internals"),getImageUrl=_require.getImageUrl;function renderChildren(r){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:"";return Array.isArray(r.children)?r.children.join(e):r.children}function block(r){var e=r.node.style||"normal";return/^h\d$/.test(e)?new Array(parseInt(e[1],10)+1).join("#")+" "+renderChildren(r):"blockquote"===e?"> "+renderChildren(r):renderChildren(r)}function RawMarkSerializer(r,e){return""+r+renderChildren(e)+r}function link(r){var e=r.mark,n=e.href,i=e.title,t=i?" "+JSON.stringify(i):"";return"["+renderChildren(r)+"]("+n+t+")"}function list(r){var e=new Array(r.level||1).join("  ");return e+renderChildren(r,"\n"+e)}function listItem(r){return("bullet"===r.node.listItem?"*":r.index+1+".")+" "+renderChildren(r)}function image(r){var e=r.title;return"!["+(r.alt||"")+"]("+getImageUrl(r)+(e?" "+JSON.stringify(e):"")+")"}function container(r){return renderChildren(r,"\n\n")}function hardBreak(){return"  \n"}module.exports={types:{block:block,image:image},marks:{"strike-through":RawMarkSerializer.bind(null,"~~"),em:RawMarkSerializer.bind(null,"_"),code:RawMarkSerializer.bind(null,"`"),strong:RawMarkSerializer.bind(null,"**"),underline:renderChildren,link:link},list:list,listItem:listItem,container:container,hardBreak:hardBreak,markFallback:renderChildren};

},{"@sanity/block-content-to-hyperscript/internals":4}],3:[function(require,module,exports){
"use strict";var _require=require("@sanity/block-content-to-hyperscript/internals"),getImageUrl=_require.getImageUrl,getSerializers=_require.getSerializers,blocksToNodes=_require.blocksToNodes,mergeSerializers=_require.mergeSerializers,mdSerializers=require("./serializers"),renderNode=function(e,r,i){var a=i||r.node&&r.node.children;return e(Object.assign({},r,{children:a}))},_getSerializers=getSerializers(renderNode),defaultSerializers=_getSerializers.defaultSerializers,serializeSpan=_getSerializers.serializeSpan,markdownSerializers=mergeSerializers(defaultSerializers,mdSerializers),toMarkdown=function(e){var r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},i=e||[],a=mergeSerializers(markdownSerializers,r.serializers||{}),l=Object.assign({},r,{blocks:i,serializers:a,listNestMode:"last-child"});return blocksToNodes(renderNode,l,defaultSerializers,serializeSpan).trim()};toMarkdown.defaultSerializers=defaultSerializers,toMarkdown.getImageUrl=getImageUrl,module.exports=toMarkdown;
