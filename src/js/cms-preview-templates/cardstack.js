...
export const CardPreview = createClass({
	render: function() {
		...
		return <div>
			<main
				class="l-grid-container l-grid-container--navoffset cardtest-main"
			>
				<article class=${colorClass}>
					<section class="cardstack__cards">
						<div class="stackcard">
							...
							>
								<div
									class="stackcard__body stackcard__body--lower"
								>
									<div class="stackcard__borderwrapper">
										<div
											class="stackcard__borderelements stackcard__borderelements--lower"
										>
											<span
												class="stackcard__borderpiece"
											></span>
					...
					<section class="cardstack__details">
						...
						<a class="cardstack__link" href="/"> sources </a>
					</section>
				</article>
			</main>
		</div>;
